...
var GUIAProveedoresPLM = angular.module('GUIAProveedoresPLM',['ngRoute','ngSanitize','ui.bootstrap','ngMap']);
	...
	GUIAProveedoresPLM.config(['$routeProvider','$locationProvider', function($routeProvider, $locationProvider, $location) {
	  ...
	  .when("/buscadores",{
	    ...
	    templateUrl:"resources/view/buscadoresView.html"
	  })

	   /*Produto*/
	  .when("/producto/:productName-:productId",{
	    controller:"productoCtrl",
	    templateUrl:"resources/view/productoView.html"
	  })

	  /*Produto detalle*/
	  .when("/producto-informacion/:productName-:productId",{
	    controller:"productoInformacionCtrl",
	    templateUrl:"resources/view/productoInformacionView.html"
	  })

	   /*Empresa*/
	  .when("/directorio-comercial-mexico/:letter",{
	    controller:"directorioMexicoCtrl",
	    templateUrl:"resources/view/directorioMexicoView.html"
	  })
      
	  .when("/empresa/:clientName-:clientId",{
	    controller:"empresaCtrl",
	    templateUrl:"resources/view/empresaView.html"
	  })
	  ...
	  .when("/localizacion/:clientName-:clientId",{
	    ...
	    templateUrl:"resources/view/localizacionView.html"
	  })
	  ...
	  .when("/hospitales",{
	    ...
	    templateUrl:"resources/view/hospitalesView.html"
	  })

	  .when("/hospital-informacion/:hospitalName:hospitalId",{
	    controller:"hospitalInformacionCtrl",
	    templateUrl:"resources/view/hospitalInformacionView.html"
	  })
